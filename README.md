...
To run gost on Debian, you need a properly built binary. You can build it yourself, or download one from **Releases** tab. When you get it done, you can use the command below:
